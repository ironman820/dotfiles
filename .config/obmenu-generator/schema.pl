...
our $SCHEMA = [
	{sep => "ArcoLinux"},
    #          COMMAND                 LABEL                ICON
    {item => ['exo-open --launch TerminalEmulator',                                 'Terminal',          'alacritty']},
    ...
    {sep => undef},
    {pipe => ['~/.config/openbox/scripts/playonlinux.sh', 'PlayOnLinux', 'playonlinux']},
    {sep => undef},
    {pipe => ['~/.config/openbox/scripts/virtualbox.sh', 'Virtual Machines', 'virtualbox']},
    {sep => undef},
    ...
    #{pipe => ['obdevicemenu', 'Devices', 'folder']},
